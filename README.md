...
<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Inter&weight=500&size=20&pause=1000&color=58A6FF&center=true&vCenter=true&width=520&lines=Building+Waste-Trade...;Competing+on+Kaggle...;Learning+Machine+Learning...">
  </a>
</p>
...
Computer Science student from 🇩🇿 Algeria building full-stack software while transitioning into Machine Learning.

Currently building <strong>Waste-Trade</strong>, competing on Kaggle, and learning in public.
...
AI-powered waste exchange platform connecting people, recyclers and organizations with intelligent recommendations.

**Stack**

`React Native` • `Next.js` • `Express` • `PostgreSQL` • `Prisma`
...
Voice-powered learning assistant using conversational AI.
...
Platform for managing doctoral competition applications and committee workflows.
...
Documenting my progress through Kaggle competitions and personal projects.
...
<p>
<img src="https://skillicons.dev/icons?i=react,nextjs,ts,tailwind,react" />
</p>
